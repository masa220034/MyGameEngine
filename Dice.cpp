...
HRESULT Dice::Initialize()
{
	...
	//インデックス情報
	int index[] = { 0,2,3, 0,1,2,        //正方形(前)
					4,6,7, 4,5,6,        //正方形(上)
					8,10,11, 8,9,10,     //正方形(後ろ)
					12,14,15, 12,13,14,  //正方形(下)
					16,18,19, 16,17,18,  //正方形(右) 
					20,22,23, 20,21,22   //正方形(左)
	};
...
void Dice::Draw(XMMATRIX& worldMatrix)
{
	...
	Direct3D::pContext_->DrawIndexed(36, 0, 0); //三角形に分解したときの頂点の合計の数
}
